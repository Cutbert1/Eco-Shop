...
class Category(models.Model):
    ...
    slug = models.SlugField(
        ...
        unique=True,
        blank=True,
        help_text="Used in URLs. Automatically generated from the name if left blank.", # noqa
    )
    ...
    icon = models.CharField(
        max_length=80,
        blank=True,
        help_text="Font Awesome icon class to visually represent the category.", # noqa
    )
...
class Product(models.Model):
    ...
    is_digital = models.BooleanField(
        default=False,
        help_text="Digital goods ignore stock tracking and always remain in stock.", # noqa
    )
